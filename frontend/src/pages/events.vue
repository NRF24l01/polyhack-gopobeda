  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <div class="p-4">
          <span class="inline-block px-2 py-1 text-sm text-purple-600 bg-purple-100 rounded-md mb-2">
            {{ event.type }}
          </span>
...
export default {
  ...
  methods: {
    ...
    showDetails(event) {
      // В будущем здесь будет переход на страницу деталей события
      console.log('Показать детали события:', event)
    }
  }
}
</script>
